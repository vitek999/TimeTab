...
class FirstWeekViewModel(application: Application) : AndroidViewModel(application) {
    /**
    ...
    class Factory(val app: Application) : ViewModelProvider.Factory {
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            if (modelClass.isAssignableFrom(FirstWeekViewModel::class.java)) {
                @Suppress("UNCHECKED_CAST")
                return FirstWeekViewModel(app) as T
            }
